              ...
              <div className='swiper-wrapper'>
                <SwiperSlide className='swiper-slide'>
                  <div className='tour-package-single2'>
                    <div className='image'>
                      <img src='assets/images/bg/package21.png' className='img-fluid' alt='image' />
                ...
                <SwiperSlide className='swiper-slide'>
                  <div className='tour-package-single2'>
                    <div className='image'>
                      <img src='assets/images/bg/package23.png' className='img-fluid' alt='image' />
                      <span className='blog-date'>
                        <i className='bi bi-calendar-check' />
                        From $2250
                      </span>
                ...
                <SwiperSlide className='swiper-slide'>
                  <div className='tour-package-single2'>
                    <div className='image'>
                      <img src='assets/images/bg/package24.png' className='img-fluid' alt='image' />
                      <span className='blog-date'>
                        <i className='bi bi-calendar-check' />
                        From $2250
                      </span>
