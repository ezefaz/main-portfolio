      ...
      <header className='header-area style-2'>
        <div className='container d-flex justify-content-between align-items-center'>
          <div className='header-logo'>
            <Link href='/'>
              <a>
                <img alt='image' className='img-fluid' src='assets/images/icons/header2-logo.svg' />
              </a>
            </Link>
          </div>
          <div className={showMobileMenu ? 'main-nav show-menu ' : 'main-nav'}>
            ...
            <ul className='menu-list'>
              <li className='menu-item-has-children'>
                ...
                <i
                  className={
                    state.activeMenu === 'home' ? 'bi bi-chevron-up dropdown-icon' : 'bi bi-chevron-down dropdown-icon'
                  }
              ...
              <li className='menu-item-has-children'>
                ...
                <i
                  className={
                    state.activeMenu === 'tour' ? 'bi bi-chevron-up dropdown-icon' : 'bi bi-chevron-down dropdown-icon'
                  }
              ...
              <li className='menu-item-has-children'>
                ...
                <i
                  className={
                    state.activeMenu === 'pages' ? 'bi bi-chevron-up dropdown-icon' : 'bi bi-chevron-down dropdown-icon'
                  }
              ...
              <li className='menu-item-has-children'>
                ...
                <i
                  className={
                    state.activeMenu === 'blog' ? 'bi bi-chevron-up dropdown-icon' : 'bi bi-chevron-down dropdown-icon'
                  }
              ...
              <li>
                <Link href='/contact'>
                  <a className={currentRoute === '/contact' ? 'active' : 'disabled'}>Contact Us</a>
                </Link>
              </li>
            </ul>
            {/* mobile-search-area */}
            ...
            <Link href='/tour-package-details'>
              <a className='eg-btn btn--primary btn--lg d-lg-none d-flex mt-5'>Book A Trip</a>
            </Link>
          </div>
          <div className='nav-right d-flex jsutify-content-end align-items-center gap-5'>
            ...
            <div className='mobile-menu-btn d-lg-none d-block' onClick={handleMobileMenu}>
