...
function MainNav() {
  ...
  return (
    <div className='main-nav'>
      <div className='menu-close-btn' onClick={onRemoveClick}>
      ...
      <ul className='menu-list'>
        <li className='menu-item-has-children'>
          <Link href='#'>
            <a className='drop-down'>
              <img src='assets/images/icons/home-icon.svg' alt='image' /> Home
            </a>
          </Link>
        ...
        <li className='menu-item-has-children'>
          <Link href='/destination'>
            <a className='drop-down'>
              <img src='assets/images/icons/desitnation-icon.svg' alt='image' /> Destination
            </a>
          </Link>
          <i className='bi bi-chevron-down dropdown-icon' />
          <ul className='sub-menu'>
        ...
        <li className='menu-item-has-children'>
          <Link href='/blog-grid'>
            <a>
              <img src='assets/images/icons/tour-icon.svg' alt='image' /> Tours
            </a>
          </Link>
          <i className='bi bi-chevron-down dropdown-icon' />
          <ul className='sub-menu'>
        ...
        <li className='menu-item-has-children'>
          <Link href='#'>
            <a className='drop-down'>
              <img src='assets/images/icons/pages.svg' alt='image' /> Pages
            </a>
          </Link>
          <i className='bi bi-chevron-down dropdown-icon' />
          <ul className='sub-menu'>
        ...
        <li className='menu-item-has-children'>
          <Link href='/blog-grid'>
            <a>
              <img src='assets/images/icons/blog-icon.svg' alt='image' /> Blog
            </a>
          </Link>
          <i className='bi bi-chevron-down dropdown-icon' />
          <ul className='sub-menu'>
        ...
        <li>
          <Link href='/contact'>
            <a>
              <img src='assets/images/icons/contact-icon.svg' alt='image' /> Contactus
            </a>
          </Link>
        </li>
      </ul>
