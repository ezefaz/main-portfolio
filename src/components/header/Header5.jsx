...
function Header5() {
  ...
  return (
    ...
    <div className="nav-right d-flex jsutify-content-end align-items-center gap-5">
      ...
      <div className="phone-call sibling3 justify-content-start align-items-center flex-row d-xxl-flex d-none">
        <div className="icon">
    ...
    <div className="header-logo">
      <Link href="/"><a><img alt="image" className="img-fluid" src="assets/images/icons/header5-logo.svg" /></a></Link>
    </div>
    <div className={showMobileMenu ? "main-nav show-menu " : "main-nav"}>
            ...
            <Link href="/tour-package-details">
              <a className="eg-btn btn--primary3 btn--lg d-xl-none d-flex mt-5">
                Book A Trip
              </a>
            </Link>
          </div>
